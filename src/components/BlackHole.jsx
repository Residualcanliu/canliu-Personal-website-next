  ...
  useEffect(() => {
    ...
    function createStarfieldTexture() {
      ...
      const stars = [
        ...
        // Sagittarius (人马座, scale 0.6)
        [0.1622,0.425],[0.1611,0.4418],[0.1397,0.434],[0.1313,0.4612],[0.1262,0.4936],
        [0.1474,0.5084],[0.1713,0.498],[0.1786,0.5035],[0.1786,0.4888],[0.1876,0.5004],
        [0.1803,0.5258],[0.1754,0.5227],[0.1626,0.535],[0.2042,0.5063],[0.2186,0.5235],
        [0.209,0.4874],[0.2193,0.4821],[0.2338,0.4918],[0.2044,0.4674],[0.209,0.457],
      ];
      // 星座连线
      const lines = [
        [2,3],[3,4],[4,5],[5,6],[3,7],[7,8],[0,2],[0,1],[1,8], // Leo
        [8+9,6+9],[6+9,7+9],[1+9,2+9],[2+9,3+9],[6+9,1+9],[6+9,3+9],[1+9,0+9],[3+9,4+9],[4+9,5+9],[7+9,13+9],[13+9,12+9],[12+9,14+9],[14+9,15+9],[15+9,16+9],[11+9,10+9],[10+9,9+9],[9+9,8+9], // Orion (offset 9 = 9 Leo stars)
        [0+26,1+26],[1+26,3+26],[3+26,2+26],[2+26,0+26],[2+26,1+26],[3+26,4+26], // Lyra (offset 26 = 9+17)
        [6+31,5+31],[5+31,2+31],[2+31,4+31],[4+31,7+31],[7+31,8+31],[2+31,3+31],[2+31,1+31],[1+31,0+31], // Cygnus (offset 31 = 9+17+5)
        // Sagittarius (offset 40 = 9+17+5+9)
        [0+40,2+40],[2+40,1+40],[2+40,3+40],[3+40,4+40],[4+40,5+40],[5+40,6+40],[6+40,7+40],[7+40,9+40],[9+40,8+40],[8+40,6+40],[7+40,10+40],[9+40,13+40],[9+40,15+40],[13+40,14+40],[15+40,16+40],[15+40,18+40],[16+40,17+40],[8+40,18+40],[18+40,19+40],[10+40,11+40],[11+40,12+40],
      ];
      // Glow pass
